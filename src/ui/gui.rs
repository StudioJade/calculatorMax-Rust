...
fn setup_chinese_fonts(ctx: &egui::Context) {
    ...
    {
        let mut font_family = fonts.families
        ...
        fonts.families.insert(egui::FontFamily::Proportional, font_family.clone());
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            if self.show_settings {
                ...
                ui.horizontal(|ui| {
                    if ui.checkbox(&mut self.settings.safe_mode, self.translations.get("safe_mode", self.language)).changed() {
                        self.evaluator.set_safe_mode(self.settings.safe_mode);
                    }
            ...
            if self.show_history {
                ...
                ui.horizontal(|ui| {
                    ...
                    if ui.button(self.translations.get("save_history", self.language)).clicked() {
                        self.save_history();
                    }
                });
            }
